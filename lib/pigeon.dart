...
class ExposureTimeRange {
  ...
  static ExposureTimeRange decode(Object result) {
    result as List<Object?>;
    return ExposureTimeRange(
      minMicroseconds: result[0]! as int,
      maxMicroseconds: result[1]! as int,
    );
  }
}
...
class CameraInterface {
  ...
  Future<ExposureTimeRange> getExposureTimeRange() async {
    final String pigeonVar_channelName = 'dev.flutter.pigeon.camerawesome.CameraInterface.getExposureTimeRange$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
    ...
    if (pigeonVar_replyList == null) {
      ...
      return (pigeonVar_replyList[0] as ExposureTimeRange?)!;
    }
  }

  Future<bool> isManualExposureSupported() async {
    final String pigeonVar_channelName = 'dev.flutter.pigeon.camerawesome.CameraInterface.isManualExposureSupported$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
  ...
  Future<void> setExposureTime(int durationMicros) async {
    final String pigeonVar_channelName = 'dev.flutter.pigeon.camerawesome.CameraInterface.setExposureTime$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
    ...
    final List<Object?>? pigeonVar_replyList =
        await pigeonVar_channel.send(<Object?>[durationMicros]) as List<Object?>?;
    if (pigeonVar_replyList == null) {
      throw _createConnectionError(pigeonVar_channelName);
    } else if (pigeonVar_replyList.length > 1) {
      throw PlatformException(

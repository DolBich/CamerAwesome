...
@interface ExposureTimeRange ()
+ (ExposureTimeRange *)fromList:(NSArray<id> *)list;
+ (nullable ExposureTimeRange *)nullableFromList:(NSArray<id> *)list;
- (NSArray<id> *)toList;
@end
...
@implementation ExposureTimeRange
+ (instancetype)makeWithMinMicroseconds:(NSInteger )minMicroseconds
    maxMicroseconds:(NSInteger )maxMicroseconds {
  ExposureTimeRange* pigeonResult = [[ExposureTimeRange alloc] init];
  pigeonResult.minMicroseconds = minMicroseconds;
  pigeonResult.maxMicroseconds = maxMicroseconds;
  return pigeonResult;
}
+ (ExposureTimeRange *)fromList:(NSArray<id> *)list {
  ExposureTimeRange *pigeonResult = [[ExposureTimeRange alloc] init];
  pigeonResult.minMicroseconds = [GetNullableObjectAtIndex(list, 0) integerValue];
  pigeonResult.maxMicroseconds = [GetNullableObjectAtIndex(list, 1) integerValue];
  return pigeonResult;
}
+ (nullable ExposureTimeRange *)nullableFromList:(NSArray<id> *)list {
  return (list) ? [ExposureTimeRange fromList:list] : nil;
}
- (NSArray<id> *)toList {
  return @[
    @(self.minMicroseconds),
    @(self.maxMicroseconds),
  ];
}
@end
...
void SetUpCameraInterfaceWithSuffix(id<FlutterBinaryMessenger> binaryMessenger, NSObject<CameraInterface> *api, NSString *messageChannelSuffix) {
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:[NSString stringWithFormat:@"%@%@", @"dev.flutter.pigeon.camerawesome.CameraInterface.getExposureTimeRange", messageChannelSuffix]
        binaryMessenger:binaryMessenger
        codec:nullGetPigeonCodec()];
    if (api) {
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:[NSString stringWithFormat:@"%@%@", @"dev.flutter.pigeon.camerawesome.CameraInterface.isManualExposureSupported", messageChannelSuffix]
        binaryMessenger:binaryMessenger
        codec:nullGetPigeonCodec()];
    if (api) {
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:[NSString stringWithFormat:@"%@%@", @"dev.flutter.pigeon.camerawesome.CameraInterface.setExposureTime", messageChannelSuffix]
        binaryMessenger:binaryMessenger
        codec:nullGetPigeonCodec()];
    if (api) {
